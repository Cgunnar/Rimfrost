...
namespace Engine1
{
	...
	void Scene0::setUpScene()
	{
		...
		glassCube->localMatrix.setPosition(-3, 0, 0);
		...
		sun->localMatrix.setPosition(0, 2.0f, -10);
		...
		nanoSuit1->localMatrix.setPosition(25, 0, -7);
		...
		nanoSuit3->localMatrix.setPosition(8, 0, -7);
		...
		nanoSuit4->localMatrix.setPosition(8, 0, 7);
		...
		nanoSuit6->localMatrix.setPosition(-8, 0, 7);
		...
		nanoSuit7->localMatrix.setPosition(-25, 0, -7);
		...
		nanoSuit8->localMatrix.setPosition(-25, 0, 7);
